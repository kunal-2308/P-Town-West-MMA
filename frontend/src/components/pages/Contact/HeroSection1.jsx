        ...
        <div className="absolute inset-0 flex items-center justify-center text-center p-40">
          <div className="div-1 flex flex-col gap-y-10 w-auto h-auto pt-8">
            <div className="div-a flex flex-col justify-start items-start w-[70%] gap-y-7">
              <span className="text-5xl text-customYellow font-medium">
                Get in Touch
              </span>
              <span className="text-white text-start text-sm font-medium">
                We&apos;re here to help you on your fitness journey, whether
                you&apos;re interested in joining one of our programs, have
                questions about our services, or need more information. Our
                dedicated team is ready to assist you with any inquiries you may
                have.
              </span>
            </div>
            <div className="div-b flex flex-col justify-start items-start w-[60%] gap-y-3">
              <span className="text-customYellow text-3xl font-medium">
                Visit Us
              </span>
              <span className="text-white text-start text-xs font-medium">
                Ground Floor, Vithala Rukmini Mandir,
                <br /> Baner Gaon, Pune, Maharashtra 411045
              </span>
            </div>
            <div className="div flex flex-col justify-start items-start gap-y-2">
              <div
                className="div-1 flex justify-center items-center gap-x-4 hover:cursor-pointer"
                onClick={copyItem}
              >
              ...
              <div className="div-1 flex justify-center items-center gap-x-4">
                ...
                <span
                  ...
                  onClick={() =>
                    (window.location = "mailto:PTOWNWESTMMA@GMAIL.COM")
                  }
                >
                  PTOWNWESTMMA@GMAIL.COM
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="div-mobile flex flex-col w-screen md:hidden relative">
        <div className="main-container mt-12 relative">
          ...
          <div className="div-text-section absolute bottom-4 left-4 flex flex-col">
            <span className="text-customYellow text-2xl font-light pl-1">
              Feel Free to
            </span>
            <span className="text-customYellow text-3xl font-medium">
              Connect With Us
        ...
        <div className="contact-section w-screen flex flex-col justify-start items-start gap-y-4 bg-black text-white p-6">
          ...
          <span className="text-white text-sm font-medium pr-3">
            Ground Floor, Vithala Rukmini Mandir, Baner Gaon, Pune, Maharashtra
            411045
          </span>
        </div>
