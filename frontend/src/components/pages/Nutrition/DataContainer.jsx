  ...
  return (
    <>
      <div className="hidden md:flex div-main-container bg-white w-auto h-auto mb-12">
        <div className="div-content-title-container flex md:hidden flex-col justify-start items-start lg:pl-48 lg:pt-8 lg:gap-y-10">
          ...
          <div className="div lg:pl-10">
            <Link to='/contact'><Button className="bg-customYellow text-black rounded-full w-[160px] hover:bg-customYellow hover:cursor-pointer">
      ...
      <div className="div-mobile bg-white hidden md:flex justify-center items-center w-screen h-auto flex-col p-10 gap-y-5">
        ...
        <div className="div lg:pl-10">
            <Link to='/guest/dashboard'><Button className="bg-customYellow text-black rounded-full w-auto hover:bg-customYellow hover:cursor-pointer">
