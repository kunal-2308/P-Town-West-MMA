        ...
        <>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start w-full gap-x-6 lg:gap-x-12 mb-10">
                    ...
                    <div className="flex-1">
                        <div className="pl-6 lg:pl-14 mt-8 lg:mt-14">
                            <span className="text-black font-semibold text-lg lg:text-2xl">Classes for Beginners</span>
                    ...
                    <div className="flex-1 lg:pr-12">
                        <div className="pl-6 lg:pl-14 mt-8 lg:mt-14">
                            <span className="text-black font-semibold text-lg lg:text-2xl">Advanced Muay Thai Classes</span>
            ...
            <div className="flex md:hidden bg-white w-screen flex-col pb-10">
                ...
                <div className="px-6 mt-8">
                    <span className="text-black font-semibold text-xl">Classes for Beginners</span>
                ...
                {/* Advanced Classes */}
                <div className="px-6 mt-8">
                    <span className="text-black font-semibold text-xl">Advanced Muay Thai Classes</span>
                    <span className="text-sm block mt-2">
                        Our advanced classes are designed for practitioners looking to refine their skills:
                    </span>
                </div>
