        ...
        <>
            <div className="main-container mt-2">
                ...
                <TrainerCardLeft name="JONATHAN ROBERTS" role="(PRO BJJ TRAINER)" desc="Jonathan Roberts is a highly seasoned Brazilian Jiu-Jitsu (BJJ) black belt with 15 years of dedicated practice, during which he has mastered the art and intricacies of BJJ. As a professional BJJ trainer, Jonathan offers unparalleled coaching, drawing from his deep well of experience and knowledge. He excels in teaching both fundamental and advanced grappling techniques, ensuring his students not only learn the moves but also understand the strategic concepts behind them. Jonathan’s ability to break down complex techniques and strategies makes him an exceptional instructor, guiding students of all levels toward achieving excellence in Brazilian Jiu-Jitsu." img="/images/Trainers/L3.png" />
                    ...
                    <TrainerCardLeft name="LALIT ASWAR" role="(MMA AND BOXING PRACTITIONER FOR 8 YEARS)" desc="Lalit Aswar is a dedicated MMA and boxing practitioner with over eight years of experience in combat sports. A fierce competitor and disciplined athlete, he has honed his skills through rigorous training, relentless perseverance, and an unyielding passion for martial arts.

Lalit has showcased his talent on the national stage, earning a gold medal in MMA and proving himself as a formidable fighter. His expertise spans various striking and grappling techniques, making him a well-rounded martial artist. With a strong commitment to fitness, discipline, and sportsmanship, he continues to inspire aspiring fighters and push his limits in the world of combat sports.
...
" img="/images/Trainers/L2.png" />
                    ...
                    <TrainerRight name="SAYEE PATIL" role="(NATIONAL BJJ SILVER MEDALIST)" desc="With over 5 years of experience in Brazilian Jiu Jitsu (BJJ), Sayee Patil is a dedicated practitioner and a National BJJ Silver Medalist from 2022. As an instructor for our beginners' BJJ classes, Sayee excels at breaking down techniques to help newcomers build a solid foundation in the art. A self-defense expert, Sayee combines practical combat skills with a focus on discipline and confidence, ensuring every student feels empowered and prepared. Passionate about teaching and growth, Sayee creates a supportive environment where students can thrive and unlock their potential." img="/images/Trainers/R3.png" />
                </div>
            </div>
