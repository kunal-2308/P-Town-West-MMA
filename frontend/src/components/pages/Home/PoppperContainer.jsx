            ...
            <div className="main-popper-container bg-white m-4 flex flex-wrap justify-center items-center gap-5">
                ...
                >
                    <div className="elements flex flex-col mb-3 gap-1">
                        <span className='text-customYellow font-medium text-4xl sm:text-5xl'>Top</span>
                        <span className='text-customYellow font-medium text-4xl sm:text-5xl'>Notch</span>
                        <span className='text-customYellow font-medium text-4xl sm:text-5xl'>Facilities</span>
                    </div>
                </div>
                ...
                <div className="div-2-popper flex flex-col gap-2 w-[100%] sm:w-[360px]">
                    ...
                    <div className="div-2-b-green bg-customYellow w-full h-[189px] rounded-lg transform transition-transform duration-300 ease-in-out hover:scale-105">
                        <div className="div-1-rating pl-7 pt-5">
                            <img src="/images/Home/Popper/star.png" alt="starRating" className='w-[110px] h-[23px]' />
                        </div>
                        <div className="div-2-title flex flex-col">
                            <span className='font-semibold text-2xl pl-7 mt-4'>Expert Trainers</span>
                            <span className='font-light text-sm pl-7 pr-2 mt-2'>Master your skills with our expert-level MMA, Muay Thai, kickboxing, boxing, and wrestling training programs in Pune, Baner, led by top-tier coaches for unparalleled advancement.</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url('/images/Home/Popper/3.png')`,
                    }}
                >
                    <div className="flex flex-col items-start mt-32">
                        <span className='font-medium text-customYellow text-4xl sm:text-5xl'>Beginners</span>
                        <span className='font-medium text-customYellow text-4xl sm:text-5xl'>Friendly</span>
                        <span className='font-medium text-customYellow text-4xl sm:text-5xl'>Training</span>
                        <span className='text-white font-normal text-base mt-5 p-2'>Join our beginner-friendly training programs in Pune, Baner, and kickstart your journey in MMA, Muay Thai, kickboxing, boxing, and wrestling with expert coaching and a supportive community</span>
                    </div>
                </div>
            </div>
        </>
