...
function HeroSection2() {
    return (
        <>
            <div className="hidden md:flex flex-col-reverse bg-white pt-0  max-h-min">
                {/* Top Section */}

                <div className="div-main-section flex flex-col-reverse p-20">
                ...
                {/* Image Section */}
                <div className="flex justify-end items-end w-full mr-6 lg:mr-20">
                    <img src="../../images/Kickboxing/Jitsu/jj-2.png" alt="Kickboxing Image" className="w-full lg:w-full h-[500px] lg:h-[600px]" />
                </div>
            </div>
