...
function InfoSection() {
    return (
        <>
            <div className="div-1-title pt-10 pl-52 gap-x-2 flex justify-start items-center">
            ...
            <div className="flex justify-center items-center p-4 lg:p-8 lg:ml-[115px] sm:flex-row sm:wra sm:h-auto">
                <div className="container flex flex-col md:flex-row justify-center items-center sm:gap-y-6 md:gap-x-4">
                    {/* Left Image */}
                    <div className="flex-shrink-0 w-full md:w-[40%]">
                        <img
                            src="public/images/Nutrition/2.png"
                            alt="image"
