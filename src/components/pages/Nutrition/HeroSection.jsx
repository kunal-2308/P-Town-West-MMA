      ...
      <div className="div-2 bg-black h-auto md:h-[280px] flex flex-col lg:flex-row justify-between items-center px-6 lg:px-16 py-8">
        ...
        <div className="div-1 flex flex-col justify-start items-start w-full lg:w-[600px] mb-8 lg:mb-0">
          <div className="div-a flex justify-start items-start">
            ...
            Transform Your Health <br />with Our Comprehensive <br /> Nutrition Program
            </span>
          </div>
        </div>
        ...
        <div className="div-2 flex flex-col w-full lg:w-[400px]">
          ...
          At P-TOWN WEST in Pune, Baner, our Nutrition Program is designed to complement your fitness goals and promote overall well-being. Whether you're aiming to lose weight, build muscle, enhance athletic performance, or simply adopt a healthier lifestyle, our personalized nutrition plans and expert guidance will help you achieve sustainable results.          </span>
